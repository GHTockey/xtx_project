<!-- src/views/home/components/HomeSpecial.vue -->
<template>
    <HomePanel title="最新专题">
        ...
        <template v-slot:default>
            <div class="special-list" ref="target">
                <div class="special-item" v-for="item in special.result" :key="item.id">
                    <RouterLink to="/">
...
const { special } = storeToRefs(homeStore);
const { getSpecialHandler } = homeStore;
const target = useLazyLoad(getSpecialHandler);
</script>
